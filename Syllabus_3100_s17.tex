	...
	\item The homeworks are graded ``coarsely'', that is,
		...
		\begin{equation*}
			\begin{tabular}{l|l|l|l|l}
				...
				& \parbox{.21\textwidth}{Work not submitted on time, or more than $1/4$ of problems 
				not attempted, or most solutions are incomplete, or work clearly displays lack of understanding of most of the material}\\
				\hline
				\%    & 100\%          & 90\%     & 75\% & 0\%
			\end{tabular}
		\end{equation*}
...
final exam to better incorporate into the letter grade my overall impressions
of the students' performance during the whole semester.
