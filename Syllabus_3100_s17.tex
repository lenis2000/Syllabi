...
Some things to note: 
\begin{enumerate}[$\bullet$] 
	\item \textbf{Private messages}:
		There are private messages where you can ask me questions
	...
	\item \textbf{Many other features}: 
		...
		There are numerous other plugins one can add to \texttt{Slack}, and if you can 
		think of good ones to add, please let me know (I'll have to ``turn them on'' myself).
...
\noindent \textbf{NOTE: Please don't make travel plans that conflict with the midterm or the final exam}
\smallskip
