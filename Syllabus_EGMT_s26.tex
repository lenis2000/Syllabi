...
\date{Compiled on \today, \currenttime. An up to date syllabus is always at \href{https://github.com/lenis2000/Syllabi/blob/master/Syllabus_EGMT_s26.pdf}{\texttt{this link}}. An accessible HTML version is at \href{https://github.com/lenis2000/Syllabi/blob/master/Syllabus_EGMT_s26.html}{\texttt{this link}}.}
\maketitle
...
following tasks: (TBA FOR Q3 ENGAGEMENT CLASSES)
\begin{enumerate}
\item 
...
\end{enumerate}
Completion must be documented in the Commonplace book (pages TBA), and the
