...
\subsection{Course engagement (35\%)}
...
\begin{enumerate}[$\bullet$]
	\item Weekly problem sets consist of textbook and other problems aligned with 
		...
		Tuesdays at 10am, and sometimes on Thursdays (see the schedule in \Cref{sub:schedule}).
...
held
during regular class times, on \textbf{TBA} and \textbf{TBA}.
They have
