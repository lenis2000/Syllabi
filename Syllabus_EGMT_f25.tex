...
Your single weekly submission (commonplace parts + one designated problem write-up) is due on \textbf{Sunday 10:00\,pm} on Canvas.
...
\item \textbf{Presenting team (0--12):} Correctness \& completeness (0--6); 
  Structure \& clarity at board (0--4); Response to questions (0--2).
...
\begin{enumerate}[$\bullet$]
  \item \textbf{In-class work \& explanations (35\%):}
	...
	Grade is mainly based on attendance and the number of problems
	accepted from your subgroup.
 ...
 \item \textbf{Commonplace notebook (35\%):}
	...
	\emph{Meets} (full credit), \emph{Revise a part} 
