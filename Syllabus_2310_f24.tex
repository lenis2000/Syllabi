...
\begin{itemize}
    \item You are allowed to use LLMs\footnote{By LLM, I mean ``large language model'', such as chatGPT, Claude, UVA \texttt{free microsoft copilot}, etc. There are also smaller but locally hosted models, see \texttt{ollama.com}. UVA copilot and locally hosted models do not raise any privacy concerns, as they do not store your data.} to help you understand the material better, or to fix your grammar / English, if needed. This use is allowed and encouraged \textbf{when you do not paste your homework problems} directly into the AI tools or solvers, but rather ask them for hints or clarifications.
    
    \item I \textbf{generally encourage} you to use Wolfram Alpha, Mathematica, google colab, or LLMs to check aspects of your ideas when solving homework problems. This can be a great learning opportunity. However, you should not use these tools to solve the problems for you. The main reason is that this will not prepare you for quizzes and midterms/final exam. Thus, \textbf{the use of AI/solver tools for completely solving homework problems is not allowed.}
    
    \item A good (and encouraged) practice is to \textbf{ask for hints}. See this
			\href{https://gist.github.com/lenis2000/cb5ea004f8aa6461be71398e19ae488e}{\textcolor{green!70!black}{\texttt{gist}}} for a template on how to ask an LLM for hints. You can use this phrasing, and it is allowed to paste a homework problem within this framing into an LLM.
			 \textit{Added bonus}: LLMs are not great at math, and this way, you will avoid getting a wrong direct answer.
    
    \item Occasionally, homework problems will contain harder problems, for which I will allow to use any resources, including all LLMs, Wolfram Alpha, Mathematica, google colab, etc. This will be clearly stated in the assignment.
\end{itemize}
