...
\bigskip
	...
	\textbf{Questions to the instructor:} We use \texttt{Piazza}, see \Cref{comm}
...
\begin{itemize}
	\item \textbf{Lectures} are pre-recorded and are uploaded to Panopto (collab $\to$ lecture capture). 
		...
		\url{https://raw.githubusercontent.com/lenis2000/Math3100_F20_LectureNotes/master/lecture_notes.pdf}
	\item \textbf{Discussion meetings} are during scheduled class times
		...
		See \Cref{sub:zoom} below for zoom suggestions and policies.
	...
	\item \textbf{Off-time} discussions and questions 
		...
		on Mondays and Thursdays, and you can also sign up for office hours appointment (see \Cref{sub:meeting_times}
		for links).
