...
\colorbox{yellow}{\parbox{.7\textwidth}{todo}}
...
\colorbox{yellow}{\parbox{.7\textwidth}{ref \Cref{sub:problem_solving} 
ref here}}
...
\colorbox{yellow}{\parbox{.7\textwidth}{Come to office hours - for each student (and give credit for this)}}
...
ask your mathematical questions on slack.
...
getting a negative probability or probability strictly greater than 1;
getting a negative variance; and so on.
It is expected that you use this common sense to filter out 
obviously wrong answers.
Solid partial credit will be given even in the case when you get an obviously
wrong answer, and note 
\begin{quote}
	``this answer is clearly incorrect because $\{\textnormal{expanation}\}$''.
\end{quote}
