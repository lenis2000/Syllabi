...
\author{Leonid Petrov \\ Fall 2026}
\date{Compiled on \today, \currenttime. An up to date syllabus is always at \href{https://lpetrov.cc/teaching/Syllabus_EGMT_f26.pdf}{\texttt{this link}}. An accessible HTML version is at \href{https://lpetrov.cc/teaching/Syllabus_EGMT_f26.html}{\texttt{this link}}.}
\maketitle
...
& \qquad \qquad \qquad TBA (posted on Canvas), \\
& \qquad \qquad \qquad or by appointment (email me; you can make \\
& \qquad \qquad \qquad as many appointments as you need)
\end{tabular}

\smallskip
\noindent\textbf{Course Info:} EGMT 1520-206 (19629) --- Empirical Engagement.

\smallskip
\noindent\textbf{Weekly rhythm:} Class meets \textbf{Mondays and Wednesdays 3:30PM -- 4:45PM} in \textbf{Gilmer Hall 247}.
\begin{itemize}
    \item \textbf{Dates:} October 19, 2026 -- December 7, 2026.
    \item \textbf{No Class:} November 25 (Thanksgiving break).
    \item \textbf{All 14 class meetings, by week:}
    \begin{itemize}
        \item Week 1: Mon Oct 19, Wed Oct 21
        \item Week 2: Mon Oct 26, Wed Oct 28
        \item Week 3: Mon Nov 2, Wed Nov 4
        \item Week 4: Mon Nov 9, Wed Nov 11
        \item Week 5: Mon Nov 16, Wed Nov 18
        \item Week 6: Mon Nov 23 --- \emph{special meeting --- Math Casino} (no class Wed --- Thanksgiving)
        \item Week 7: Mon Nov 30, Wed Dec 2
        \item Week 8: Mon Dec 7
    \end{itemize}
\end{itemize}
...
This component is an integral part of the Engagements program.
% TODO: replace with the official Quarter 2 Engaging Grounds tasks when
% the Engagements program distributes them.
The specific tasks for this quarter will be distributed by the
Engagements program and posted on Canvas.
...
Attendance is required to earn credit. A problem is ``accepted'' when your subgroup can answer follow-ups and defend key steps without unresolved gaps.
 ...
 \item \textbf{Commonplace notebook (40\%):}
	...
	Complete the assigned tasks in the Commonplace book, and
...
\begin{enumerate}[$\bullet$]
    \item (excused absences) Authorized university activities (such as university-sponsored athletic events) and the observance of religious holidays are considered excused absences. However, you must submit a written request detailing the dates of these absences directly to me by email by \textbf{October 27}. If these types of absences would result in you missing more than 2 of the required class meetings, you may need to switch to a different course with fewer scheduling conflicts.
